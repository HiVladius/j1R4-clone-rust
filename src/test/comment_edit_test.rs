...
use crate::{
    helpers::helper_setup_app::{
        create_project_for_user, create_task_for_project, get_auth_token, get_auth_token_and_id,
        setup_app,
    },
        ...
        .oneshot(
            Request::builder()
                ...
                .header(
                    ...
                    format!("Bearer {}", author_user_token),
                )
                .header(header::CONTENT_TYPE, "application/json")
